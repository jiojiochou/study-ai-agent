...
async function inMemoryDemo() {
    ...
    const systemessage = new SystemMessage(
    ...
    const messsage1 = [systemessage, ...(await history.getMessages())]
    const response1 = await model.invoke(messsage1)
    ...
    const messsage2 = [systemessage, ...(await history.getMessages())]
    const response2 = await model.invoke(messsage2)
